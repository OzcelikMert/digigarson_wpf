    ...
    public class UpdaterInitialize
    {
        ...
        private void BgWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e) {
            ...
            if (!e.Cancelled) {
                ...
                MessageBox.Show("İndirme iptal edildi!", "Güncelleme Mesajı", MessageBoxButton.OK, MessageBoxImage.Information);
        ...
        private void DownloadUpdate(UpdaterXml update, UpdaterValues applicationInfo) {
            ...
            UpdaterWindow updaterWindow = new UpdaterWindow(update.Uri, update.MD5, applicationInfo.ApplicationIcon);
        ...
        private void UpdateApplications() {
            try {
                ...
                if (curAppidx > -1) {
                    ...
                    argument_complete = string.Format(argument_start, Path.GetDirectoryName(ParentPath), "Digigarson.exe");
